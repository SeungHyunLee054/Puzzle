...
// PuzzleDoc.cpp: CPuzzleDoc 클래스의 구현
//
...
CPuzzleDoc::CPuzzleDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CPuzzleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CPuzzleDoc::InitializeSearchContent()
{
...
void CPuzzleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
